...
export default function RegistrarEquipo() {
  ...
  const [form, setForm] = useState({
    marca: "", modelo: "", serie: "", capacidad: "", ubicacion: "",
    estado: "Operativo", ultimoMantenimiento: "", observaciones: "",
    correctivos: "", recomendaciones: ""
  });
    ...
    <div style={styles.container}>
      <div style={styles.card}>
        ...
        <form onSubmit={handleSubmit}>
          <p style={styles.seccion}>📋 Datos del equipo</p>
          <div style={styles.grid2}>
            ...
            <div>
              ...
              <input style={styles.input} name="modelo" placeholder="FTXS35KVMA" value={form.modelo} onChange={handleChange} required />
            </div>
            <div>
          ...
          <div>
            ...
            <input style={styles.input} name="ubicacion" placeholder="Sala principal, Piso 3, Empresa XYZ" value={form.ubicacion} onChange={handleChange} required />
          </div>
          ...
          <div>
            ...
            <textarea style={styles.textarea} name="observaciones" placeholder="Descripción del mantenimiento realizado..." value={form.observaciones} onChange={handleChange} />
          </div>

          <div>
            <label style={styles.label}>Correctivos realizados</label>
            <textarea style={styles.textarea} name="correctivos" placeholder="Reemplazo de capacitor, recarga de gas R-410A..." value={form.correctivos} onChange={handleChange} />
          </div>

          <div>
            <label style={styles.label}>Recomendaciones</label>
            <textarea style={styles.textarea} name="recomendaciones" placeholder="Limpiar filtros cada 30 días, próximo mantenimiento en..." value={form.recomendaciones} onChange={handleChange} />
          </div>

          <button style={styles.btnGuardar} type="submit">
            {equipoId ? "💾 Actualizar equipo" : "💾 Guardar y generar QR"}
          </button>
        </form>
      </div>
    </div>
...
const styles = {
  ...
  card: { background: "white", borderRadius: "12px", padding: "2rem", maxWidth: "700px", margin: "0 auto", boxShadow: "0 2px 10px rgba(0,0,0,0.08)" },
  ...
  textarea: { width: "100%", padding: "10px 12px", borderRadius: "8px", border: "1px solid #ddd", fontSize: "14px", boxSizing: "border-box", marginBottom: "1rem", minHeight: "90px", resize: "vertical" },
